  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster={posterMap[this.props.movieInfo.poster]}/>
        <CardBack title={this.props.movieInfo.title} genres={this.props.movieInfo.genres} IMDBRating={this.props.movieInfo.IMDBRating}/>
      </div>
    )
  }
}
